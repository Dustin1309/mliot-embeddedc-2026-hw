...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
    // Đọc trạng thái chân PA0 (Input Pull-up)
    if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_RESET) {
        ...
        if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0) == GPIO_PIN_RESET) {
            ...
            // Chỉ tính 1 lần nhấn duy nhất, tiến hành đảo trạng thái LED ở chân PC13
...
static void MX_GPIO_Init(void)
{
  ...
  /* Cấu hình chân PA0 làm Input Pull-up cho Task 4 */
